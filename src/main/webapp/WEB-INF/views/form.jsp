        ...
        <form:form modelAttribute="donation" action="/form" method="post">
                    ...
                    <c:forEach items="${categories}" var="category">
                       <label>
                           <form:checkbox
                                   path="categories"
                                value="${category.id}"/>
                           <span class="form-group form-group--checkbox"> ${category.name}</span>
                       </label>
                        <br>
                    </c:forEach>
            ...
            <div data-step="3">
                ...
                <div class="form-group form-group--checkbox">
                  ...
                  <div class="title" id="institution">
                          ${institution.name}
                  </div>
                  <div class="subtitle">
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Numer telefonu <form:input path="phone" type="phone" id="phone"/>
                            </label>
                        </div>
                    </div>
                ...
                <div class="summary">
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="quantityVal"></span>
                            ...
                            <li>
                                ...
                                <span class="summary--text" id="institutionVal"></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="form-section form-section--columns">
                        ...
                        <div class="form-section--column">
                            <h4>Termin odbioru:</h4>
                            <ul>
                                <li id="pickUpDateVal"></li>
                                <li id="pickUpTimeVal"></li>
                                <li id="pickUpCommentVal"></li>
                            </ul>
                        </div>
                    </div>
                </div>
